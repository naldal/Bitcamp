...
public class FriendManager2 extends JFrame implements ActionListener, ListSelectionListener {
...
//			//DB - FriendDAO
			...
			//DB - FriendDAO
			FriendDAO friendDAO = FriendDAO.getInstance();
			friendDAO.deleteArticle(friendDTO.getSeq());
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (friendDTO.getGender() == 0 ? true : false)
			male.setSelected(true);
		else
